...
/* harmony import */ var _modules_textarea__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/textarea */ "./src/js/modules/textarea.js");



window.onload = function () {
  Object(_services_default__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_modules_textarea__WEBPACK_IMPORTED_MODULE_1__["default"])();
};
...
var textarea = function textarea() {
  var area = document.querySelector('.area__textarea'),
      words = document.querySelector('.counter__words'),
      char = document.querySelector('.counter__char');

  function wordsCount(e) {
    var text = area.value.trim(); // let changedText = text.replace(/\s/g, " ");

    var wordsArr = text.split(/\s+/).filter(function (item) {
      return item;
    }).length;
  ...
  function charCount(e) {
    var text = area.value; //What we writted

    var changedText = text.replace(/[\s]/g, ''); //Delete 'space'

    var charArr = changedText.split(""); //Add to arr
